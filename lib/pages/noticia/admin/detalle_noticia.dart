...
import 'package:app_tarjeta/pages/noticia/admin/detalle_participante_page.dart';
import 'package:app_tarjeta/services/auth_service.dart';
import 'package:app_tarjeta/services/provider.dart';
import 'package:app_tarjeta/widgets/collages/card_collage.dart';
      ...
      builder: (BuildContext context, AsyncSnapshot<List<Imagen>> snapshot) {
        if (snapshot.hasData) {
          if (snapshot.data.isEmpty ||snapshot.data == null) {
            ...
            return _opcionAgregarImagen(context);

            // return _cardCollage();
            
      //       Container(
      //     // => Navigator.pushNamed(context, 'noticia', arguments: noticia).then((value) { setState(() {  });}),
      // // onPressed:()=>Navigator.pushNamed(context, 'noticia')
      // // .then((value){setState(() {
      // // });}),
      //       );
...
Widget _cardCollage(){
  return GestureDetector(
    onTap: (){
      print('agregar imagen');
    },
child: CardCollageWidget(
  texto: 'Agregar imagen',
  primeraImagen: 'assets/collages/agregar-imagen-uno.jpg',
  segundaImagen:'assets/collages/agregar-imagen-dos.jpg' ,
  terceraImagen: 'assets/collages/agregar-imagen-tres.jpg',
...
Widget _opcionAgregarImagen(BuildContext context){
        ...
        Expanded(
          child: Container(
            // color: Colors.amberAccent,
              child: Image.asset('assets/collages/agregar-imagen-uno.jpg',fit: BoxFit.fitHeight, height: double.infinity,),
              ),
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              Container(
                // color: Colors.red,
              child: Image.asset('assets/collages/agregar-imagen-tres.jpg', height: double.infinity, fit: BoxFit.cover,) ,
                
                height: 110,),
              Expanded(child: Container(
              child: Image.asset('assets/collages/agregar-imagen-dos.jpg', height: double.infinity, width: double.infinity, fit: BoxFit.cover,) ,
...
Container( height: 50,    margin: EdgeInsets.only(top: 20),  child: Text('Agregar imagen', textAlign: TextAlign.center, style: TextStyle( ),)),
...
Widget _cardCollage(){
  return GestureDetector(
    ...
    child: CardCollageWidget(
      primeraImagen: 'assets/collages/agregar-participante-uno.jpg', 
      segundaImagen: 'assets/collages/agregar-participante-dos.jpg', 
      terceraImagen: 'assets/collages/agregar-participante-tres.jpg', 
