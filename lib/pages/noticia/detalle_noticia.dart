...
// participantesBloc.cargar(noticia.id);
  ...
  Widget _crearParticipantesPage(List<Participante> participantes, BuildContext context){
      return Column(
        children: <Widget>[
              Center(child: Text('Contribuyentes', style: TextStyle( fontSize: 15),),),
SizedBox(
  height: 10,
),
          SizedBox(
 ...
 Container(
  ...
  // );
   ...
   Navigator.push(context, MaterialPageRoute<void>(
         ...
         child: Text(participante.nombre ,
         style: TextStyle(
           fontSize: 10
         ),
                      overflow: TextOverflow.ellipsis,
  ...
  opacity: 60
      ...
      // backgroundColor: Color.fromRGBO(250, 31, 38, 0.85),
        ...
        Stack(children: <Widget>[
          Container(color: Components.generalBackgroundColor,),
        Container(
